...
from nested_range_pilot import (worker, nested_violation, stage_label, sha, read_tsv, dump,
                                EPS, TOL)
...
def main(root, out, workers, budget):
    ...
    hashes["__worker__"] = sha(Path(__file__).resolve().parent / "nested_range_pilot.py")
...
if __name__ == "__main__":
    ...
    a = p.parse_args()
    main(a.root.resolve(), a.output.resolve(), a.workers, a.budget)
